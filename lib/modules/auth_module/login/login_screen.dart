...
import 'package:statistical_survey/common/valid/valid.dart';
import 'package:statistical_survey/common/widgets/input/widget_field_input.dart';
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          WidgetFieldInput(controller: controller.getEditingController(controller.keyPass),
            hint: 'hint_pass'.tr,
            bgColor: Colors.white,
